...
class Kategori_pmb extends CI_Controller {
    ...
    public function index()
    {
        ...
        $kategori = $this->kategori_model->listing_pmb();
        $data = array(  'title'     => 'Data Kategori  PMB',
                        'kategori'  =>  $kategori,
                        'konfigurasi'   =>  $konfigurasi,
                        'tata_usaha'    =>  $tata_usaha,
                        'isi'       =>  'tata_usaha/kategori_pmb/list'
                     );
    ...
    public function tambah()
    {
        ...
        $data = array(	'title' => 'Tambah Kategori PMB',
                        'tata_usaha'    =>  $tata_usaha,
                        'konfigurasi'   =>  $konfigurasi,
                        'isi'      => 'tata_usaha/kategori_pmb/tambah');
        $this->load->view('tata_usaha/layout/wrapper',$data,FALSE);
        //Masuk Database
        }else{
	    $i = $this->input;   
            ...
            $this->kategori_model->tambah_pmb($data);
            $this->session->set_flashdata('sukses','Data telah ditambah');
            redirect(base_url('tata_usaha/kategori_pmb'),'refresh');
        }
    ...
    public function edit($kode_bayar)
    {
        ...
        $kategori = $this->kategori_model->detail($kode_bayar);
        //validasi input
        $valid      = $this->form_validation;
        ...
        $data = array(  'title'     =>  'Edit Kategori SPP',
                        ...
                        'konfigurasi'   =>  $konfigurasi,
                        'tata_usaha'    =>  $tata_usaha,
                        'isi'       =>  'tata_usaha/kategori_pmb/edit'
                     );
        $this->load->view('tata_usaha/layout/wrapper', $data, false);
        //masuk database
        }else{
    ...
    public function delete($jumlah)
    {
        $data = array(  'jumlah'  =>  $jumlah,
                     );

        $this->kategori_model->delete_pmb($data);
