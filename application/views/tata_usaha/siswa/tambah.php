...
// Form Open
echo form_open_multipart(base_url('tata_usaha/siswa/tambah'), 'class="form-horizontal"');
?>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" name="nis" class="form-control" placeholder="NIS" value="<?php echo set_value('nis') ?>" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" name="nama" class="form-control" placeholder="Nama Siswa" value="<?php echo set_value('nama_siswa') ?>" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="test" name="ortulk" class="form-control" placeholder="Orang Tua Laki-laki" value="<?php echo set_value('ortu_lk') ?>" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" name="ortupr" class="form-control" placeholder="Orang Tua Perempuan" value="<?php echo set_value('ortu_pr') ?>" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" name="asalsekolah" class="form-control" placeholder="Asal Sekolah" value="<?php echo set_value('asal_sekolah') ?>" required>
    </div>
</div>
