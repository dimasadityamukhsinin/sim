<p class="pull-left">
    <div class="btn-group">
        <a href="<?php echo base_url('tata_usaha/kategori_spp')?>" title="Kembali" class="btn btn-info btn-md">
...
// Form Open
echo form_open_multipart(base_url('tata_usaha/kategori_spp/tambah'), 'class="form-horizontal"');
?>
