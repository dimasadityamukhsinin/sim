<p class="pull-left">
    <div class="btn-group">
        <a href="<?php echo base_url('tata_usaha/absen_siswa')?>" title="Kembali" class="btn btn-info btn-md">
...
// Form Open
echo form_open_multipart(base_url('tata_usaha/absen_siswa/tambah/'.$siswa->nis), 'class="form-horizontal"');
?>

<div class="form-group">
    <label class="col-md-2 control-label">NIS</label>
    <div class="col-md-5">
        <input type="text" name="nis" class="form-control" placeholder="NIP" value="<?php echo $siswa->nis ?>" readonly>
    </div>
</div>
