...
// Form Open
echo form_open_multipart(base_url('tata_usaha/jurusan/edit/'.$jurusan->kode_jurusan), 'class="form-horizontal"');
?>

<div class="form-group">
    <label class="col-md-2 control-label">Nama Jurusan</label>
    <div class="col-md-5">
        <input type="text" name="nama" class="form-control" placeholder="Nama Jurusan" value="<?php echo $jurusan->nama_jurusan ?>" required>
    </div>
</div>
