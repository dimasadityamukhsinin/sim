                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data == 'gagal'){
                            ...
                            console.log(data);
                            var dataadministrasi = JSON.parse(data);
                            $("#nip").html(dataadministrasi.nip);
                            $("#nama").html(dataadministrasi.nama_administrasi);
                        }
...
<footer class="main-footer">
    <div class="d-block hijau">
        <marquee><strong><h2 style="letter-spacing: 6px; color:white;">SELAMAT DATANG DI SMK LABOR FKIP BINAAN FKIP UNRI PEKANBARU | SILAHKAN ABSEN</h2></strong></marquee>
   </div>
</footer>
</html>