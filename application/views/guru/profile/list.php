...
// Form Open
echo form_open_multipart(base_url('guru/profile'), 'class="form-horizontal"');
?>

<div class="form-group">
    <label class="col-md-2 control-label">Foto</label>
    <div class="col-md-5">
        <img src="<?php echo base_url('assets/upload/image/'.$guru->foto) ?>" class="img img-responsive img-thumbnail" width="200">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="file" name="foto" class="form-control" placeholder="Upload Foto" value="<?php echo $guru->foto ?>" readonly>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir" value="<?php echo $guru->tempat_lahir ?>" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="date" name="tanggal_lahir" class="form-control" placeholder="Tanggal Lahir" value="<?php echo $guru->tanggal_lahir ?>" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <textarea name="alamat" class="form-control" placeholder="Alamat"><?php echo $guru->tempat_lahir ?></textarea>
    </div>
</div>
